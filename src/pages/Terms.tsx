...
const TRANSLATIONS = {
  en: {
    ...
    seoDesc:
      'The terms for using the Griot Moon website, free activities, and links to purchase books on Amazon.',
    title: 'Terms of Use',
    updated: 'Last updated: June 2026',
    intro:
      'Welcome! griotmoon.com is operated by Pawa Press Inc. By using the site you agree to these terms. They are written for parents, guardians, caregivers, and educators who use the site.',
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          'The stories, characters, illustrations, and text of the Pawa Seyni Collection are protected by copyright and remain our property or that of their respective owners. Free printable activities may be downloaded and used at home or in the classroom, but not sold or redistributed for profit.',
        ],
      },
      {
  ...
  es: {
    ...
    seoDesc:
      'Las condiciones para usar el sitio de Griot Moon, las actividades gratuitas y los enlaces para comprar libros en Amazon.',
    title: 'Términos de uso',
    updated: 'Última actualización: junio de 2026',
    intro:
      '¡Bienvenido/a! griotmoon.com es operado por Pawa Press Inc. Al usar el sitio aceptas estos términos. Están escritos para padres, tutores, cuidadores y educadores que usan el sitio.',
    sections: [
      {
  ...
  fr: {
    ...
    seoDesc:
      'Les conditions d\'utilisation du site Griot Moon, des activités gratuites et des liens pour acheter des livres sur Amazon.',
    title: 'Conditions d\'utilisation',
    updated: 'Dernière mise à jour : juin 2026',
    intro:
      'Bienvenue ! griotmoon.com est exploité par Pawa Press Inc. En utilisant le site, vous acceptez ces conditions. Elles sont rédigées pour les parents, tuteurs, accompagnants et enseignants qui utilisent le site.',
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          'Les histoires, personnages, illustrations et textes de la Collection Pawa Seyni sont protégés par le droit d\'auteur et restent notre propriété ou celle de leurs détenteurs respectifs. Les activités imprimables gratuites peuvent être téléchargées et utilisées à la maison ou en classe, mais ne peuvent être vendues ni redistribuées à but lucratif.',
        ],
      },
      {
