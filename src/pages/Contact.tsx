...
const TRANSLATIONS = {
  en: {
    seoTitle: 'Contact',
    seoDesc: "Get in touch with Griot Moon. Questions about the books, school visits, or just want to say hi? Send a message and we'll get back to you.",
    heading: 'Get in Touch with Pawa Seyni',
    ...
    successDetail: 'Thank you for reaching out. Pawa Seyni will get back to you within 24-48 hours.',
    ...
    sending: 'Sending…',
    errorMessage: "Hmm, that didn't go through. Please try again or email contact@griotmoon.com directly.",
    ...
    followLabel: 'Follow Pawa Seyni',
  },
  es: {
    seoTitle: 'Contacto',
    seoDesc: '¿Quieres contactar con Griot Moon? Preguntas sobre libros, visitas escolares o simplemente saludar. Escríbenos y te responderemos.',
    heading: 'Ponte en contacto con Pawa Seyni',
    ...
    successDetail: 'Gracias por escribir. Pawa Seyni te responderá en 24-48 horas.',
    ...
    sending: 'Enviando…',
    errorMessage: 'Vaya, no se pudo enviar. Inténtalo de nuevo o escríbenos a contact@griotmoon.com.',
    ...
    followLabel: 'Sigue a Pawa Seyni',
  },
  fr: {
    seoTitle: 'Contact',
    seoDesc: 'Contactez Griot Moon. Questions sur les livres, visites scolaires ou simplement un bonjour ? Envoyez-nous un message et nous reviendrons vers vous.',
    heading: 'Contactez Pawa Seyni',
    ...
    successDetail: 'Merci pour votre message. Pawa Seyni vous répondra sous 24 à 48 heures.',
    ...
    sending: 'Envoi…',
    errorMessage: "L'envoi a échoué. Réessayez ou écrivez à contact@griotmoon.com.",
      ...
      <section className="py-12 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            {[
              { emoji: '📧', title: t.emailTitle, value: 'contact@griotmoon.com', href: 'mailto:contact@griotmoon.com' },
