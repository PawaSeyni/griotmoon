...
const TRANSLATIONS = {
  en: {
    seoTitle: 'Fun Activities with Pawa Seyni',
    ...
    heading: 'Fun Activities with Pawa Seyni',
  ...
  es: {
    seoTitle: 'Actividades divertidas con Pawa Seyni',
    ...
    heading: 'Actividades divertidas con Pawa Seyni',
  ...
  fr: {
    ...
    heading: 'Activités amusantes avec Pawa Seyni',
