...
const TRANSLATIONS = {
  en: {
    ...
    teachers: {
      ...
      intro: 'Pawa Seyni’s printables are free to use at home or in the classroom. Download, print, and share – no sign-up needed.',
      ...
      tipsHeading: 'Using Pawa Seyni’s books in the classroom',
      tips: [
  ...
  es: {
    ...
    teachers: {
      ...
      intro: 'Los materiales de Pawa Seyni son gratuitos para usar en casa o en el aula. Descarga, imprime y comparte – sin registro.',
      ...
      tipsHeading: 'Usar los libros de Pawa Seyni en el aula',
      tips: [
    ...
    article5: {
      ...
      sections: [
        ...
        { title: 'Hazlo activo, no pasivo', body: [
          'Algunos ni\xf1os se resisten a estar quietos con un libro, pero felizmente siguen la historia mientras dibujan o construyen. Los audiolibros y las pistas de audio biling\xfces como las de los cuentos de Pawa Seyni pueden ser la puerta de entrada.',
        ] },
        ...
        { title: 'Nunca uses los libros como castigo', body: [
          'Queremos que la lectura viva en la categor\xeda de las cosas c\xe1lidas, tranquilas y deseadas. La colecci\xf3n de Pawa Seyni fue dise\xf1ada exactamente con esto en mente: historias que se sienten como una invitaci\xf3n, no como una tarea.',
        ] },
      ] satisfies Section[],
    },
    article2: {
    ...
    article6: {
      ...
      sections: [
        ...
        { title: 'La lengua materna y la identidad familiar', body: [
          'Para muchas familias, la lengua heredada no es solo comunicaci\xf3n: es un hilo hacia los abuelos, la comida, la m\xfasica, un lugar. Cuando Pawa Seyni escribe una historia biling\xfce, piensa en la abuela leyendo en espa\xf1ol mientras su nieto sigue en ingl\xe9s.',
        ] },
        { title: 'Un primer paso pr\xe1ctico', body: [
          'Elige un libro biling\xfce y comp\xf3mprometete a leerlo en ambos idiomas al menos una vez a la semana durante un mes. Empieza con la colecci\xf3n de Pawa Seyni – cada historia est\xe1 dise\xf1ada para que los dos idiomas se sientan igualmente en casa en la p\xe1gina.',
        ] },
      ] satisfies Section[],
    },
  },
    ...
    article5: {
      ...
      sections: [
        ...
        { title: 'N’utilisez jamais les livres comme punition', body: [
          'Nous voulons que la lecture vive dans la cat\xe9gorie des choses chaleureuses, tranquilles et d\xe9sir\xe9es. La collection Pawa Seyni a \xe9t\xe9 con\xe7ue exactement dans cet esprit\xa0: des histoires qui ressemblent \xe0 une invitation, pas \xe0 une t\xe2che.',
        ] },
      ] satisfies Section[],
    },
    article2: {
