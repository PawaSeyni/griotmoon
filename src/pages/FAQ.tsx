...
const TRANSLATIONS = {
  en: {
    ...
    seoDesc:
      'Answers about ages, languages, prices, read-aloud, free activities, privacy, and how to buy Pawa Seyni’s picture books.',
    heading: 'Frequently Asked Questions',
    subheading: 'Everything parents, caregivers, and teachers ask most',
    faqs: [
      { q: 'What ages are these books for?', a: 'The Pawa Seyni Collection is written for children ages 3–9. Every book on the Books page shows its own recommended age range so you can pick the right fit.' },
      { q: 'What languages can we read and listen in?', a: 'The whole site works in English, Spanish, and French. Use the EN/ES/FR switch at the top. The activities and the “Listen” read-aloud work in all three. Pawa Seyni’s books are bilingual, pairing English with Spanish or French, and more translations are on the way; each book shows the languages it’s available in.' },
      ...
      { q: 'How do I get in touch?', a: 'Use the Contact page or email contact@griotmoon.com. We usually reply within 24–48 hours.' },
    ] as QA[],
  },
  es: {
    seoTitle: 'Preguntas frecuentes',
    seoDesc:
      'Respuestas sobre edades, idiomas, precios, lectura en voz alta, actividades gratuitas, privacidad y cómo comprar los libros de Pawa Seyni.',
    heading: 'Preguntas frecuentes',
    subheading: 'Lo que más preguntan padres, cuidadores y docentes',
    faqs: [
      { q: '¿Para qué edades son estos libros?', a: 'La Colección Pawa Seyni está escrita para niños de 3 a 9 años. Cada libro en la página de Libros muestra su propio rango de edad recomendado para que elijas el adecuado.' },
      { q: '¿En qué idiomas podemos leer y escuchar?', a: 'Todo el sitio funciona en inglés, español y francés, usa el selector EN/ES/FR de arriba. Las actividades y la lectura en voz alta “Escuchar” funcionan en los tres. Los libros de Pawa Seyni son bilingües: inglés con español o francés, y vienen más traducciones; cada libro indica en qué idiomas está disponible.' },
      ...
      { q: '¿Cómo me pongo en contacto?', a: 'Usa la página de Contacto o escribe a contact@griotmoon.com. Solemos responder en 24–48 horas.' },
    ] as QA[],
  },
  fr: {
    ...
    faqs: [
      ...
      { q: 'Comment vous contacter ?', a: 'Utilisez la page Contact ou écrivez à contact@griotmoon.com. Nous répondons généralement sous 24 à 48 heures.' },
    ] as QA[],
  },
};
