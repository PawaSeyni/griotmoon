    ...
    sections: [
      {
        ...
        body: [
          ...
          'We do not knowingly collect personal information from children. If you believe a child has provided us personal information, email contact@griotmoon.com and we will delete it.',
        ],
      },
      {
      ...
      },
      {
        heading: 'Analytics',
        body: [
          'We use Plausible Analytics to understand which pages are popular. It is privacy-friendly: it uses no cookies, does not track you across sites or fingerprint your device, and collects only aggregate, anonymous statistics. It does not identify you personally.',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          'You can unsubscribe from emails at any time, and you can ask us to access or delete the information you have given us by emailing contact@griotmoon.com. Depending on where you live, you may have additional rights under laws such as the GDPR (Europe), UK GDPR, CCPA (California), or PIPEDA / Law 25 (Canada).',
        ],
      },
      {
        heading: 'Changes & contact',
        body: [
          'We may update this policy from time to time; the date above shows the latest version. Questions? Email contact@griotmoon.com.',
        ],
      },
    ] as Section[],
  },
    ...
    sections: [
      {
        ...
        body: [
          ...
          'No recopilamos a sabiendas información personal de niños. Si crees que un niño nos ha facilitado datos personales, escribe a contact@griotmoon.com y los eliminaremos.',
        ],
      },
      {
      ...
      },
      {
        heading: 'Analíticas',
        body: [
          'Usamos Plausible Analytics para saber qué páginas son populares. Respeta la privacidad: no usa cookies, no te rastrea entre sitios ni identifica tu dispositivo, y solo recopila estadísticas anónimas y agregadas. No te identifica personalmente.',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          'Puedes darte de baja de los correos cuando quieras y pedirnos acceder o eliminar la información que nos hayas dado escribiendo a contact@griotmoon.com. Según dónde vivas, puedes tener derechos adicionales bajo leyes como el RGPD (Europa), la CCPA (California) o PIPEDA / Ley 25 (Canadá).',
        ],
      },
      {
        heading: 'Cambios y contacto',
        body: [
          'Podemos actualizar esta política de vez en cuando; la fecha de arriba indica la última versión. ¿Preguntas? Escribe a contact@griotmoon.com.',
        ],
      },
    ] as Section[],
  },
    ...
    sections: [
      {
        ...
        body: [
          ...
          'Nous ne collectons pas sciemment d\'informations personnelles auprès d\'enfants. Si vous pensez qu\'un enfant nous a transmis des données personnelles, écrivez à contact@griotmoon.com et nous les supprimerons.',
        ],
      },
      {
      ...
      },
      {
        heading: 'Analyses',
        body: [
          'Nous utilisons Plausible Analytics pour savoir quelles pages sont populaires. Cet outil respecte la vie privée : sans cookies, sans suivi entre sites ni identification de votre appareil, il ne collecte que des statistiques anonymes et agrégées. Il ne vous identifie pas personnellement.',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          'Vous pouvez vous désinscrire des e-mails à tout moment et nous demander d\'accéder aux informations que vous nous avez données ou de les supprimer en écrivant à contact@griotmoon.com. Selon votre lieu de résidence, vous pouvez disposer de droits supplémentaires en vertu de lois telles que le RGPD (Europe), la CCPA (Californie) ou PIPEDA / Loi 25 (Canada).',
        ],
      },
      {
        heading: 'Modifications et contact',
        body: [
          'Nous pouvons mettre à jour cette politique de temps à autre ; la date ci-dessus indique la dernière version. Des questions ? Écrivez à contact@griotmoon.com.',
        ],
      },
    ] as Section[],
  },
