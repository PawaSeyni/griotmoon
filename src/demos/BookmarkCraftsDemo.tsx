...
const TRANSLATIONS = {
  en: {
    heading: 'Bookmark Designer with Pawa Seyni',
  ...
  es: {
    heading: 'Diseñador de marcapáginas con Pawa Seyni',
  ...
  fr: {
    heading: 'Créateur de marque-pages avec Pawa Seyni',
...
export default function BookmarkCraftsDemo() {
  ...
  const handleDownload = () => {
    ...
    ctx.fillText('griotmoon.com', W / 2, 2040);
    ctx.globalAlpha = 1;
