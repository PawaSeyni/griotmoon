...
const TRANSLATIONS = {
  en: {
    title: "Pawa Seyni's Character Creation Workshop",
  ...
  es: {
    title: 'Taller de creación de personajes con Pawa Seyni',
  ...
  fr: {
    title: 'Atelier de création de personnages avec Pawa Seyni',
