...
const SCRAMBLED_BY_LANG: Record<Language, Scramble[]> = {
  en: [
    ...
    { scrambled: 'SSKNINED', answer: 'KINDNESS', emoji: '💛', hint: 'Being caring and gentle toward others, the way Pawa Seyni treats her friends.' },
...
const TRANSLATIONS = {
  en: {
    heading: "Pawa Seyni's Puzzle Paradise",
  ...
  es: {
    heading: 'Paraíso de acertijos de Pawa Seyni',
  ...
  fr: {
    heading: "Le paradis des énigmes de Pawa Seyni",
